...
<!-- Start wrapper-->
 <div id="wrapper">
  ...
  <!--Start sidebar-wrapper super admin-->
  {{-- @if(Session::get('role')=='myth') --}}
   ...
   <ul class="sidebar-menu do-nicescrol">
      ...
      <li>
        <a href="{{url('/berandaAdmin')}}">
          <i class="zmdi zmdi-view-dashboard"></i> <span>Pertanyaan</span>
        </a>
      </li>

      <li>
        <a href="{{url('/bukuAdmin')}}">
          <i class="zmdi zmdi-invert-colors"></i> <span>Buku</span>
        </a>
      </li>
